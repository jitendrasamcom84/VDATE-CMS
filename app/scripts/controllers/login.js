...
angular.module('vdateApp')
    .controller('LoginCtrl', function ($rootScope, $scope, ApiService, AuthenticationService, alertService, ApiEndpoint, api, $http) {
            ...
            AuthenticationService.Login($scope.username, $scope.password, function (response) {
                if (response.is_error === false) {
                    ...
                    if (user.type != "admin") {
                        ...
                        var update = ApiService.postModel(ApiEndpoint.Models.USER + "/" + user.id, json);
