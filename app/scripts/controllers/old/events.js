...
angular.module('vdateApp')
    ...
    .controller('ManageEventsCtrl', function (Upload, $scope, ApiService, ApiEndpoint, $filter, $sce, $resource, _, alertService, $routeParams, $rootScope, AddressService, $location, api, blockUI) {
        $scope.eventsinfo = [];
        $scope.is_edit = false;
        ...
        var loadEventsInfo = function () {
            ApiService.getModel(ApiEndpoint.Models.EVENTS).then(function (response) {
