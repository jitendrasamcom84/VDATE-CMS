            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var smartActions = {
                        ...
                        deleteData: function ($this) {

                            // ask verification
                            $.SmartMessageBox({
                                title: "<i class='fa fa-sign-out txt-color-orangeDark'></i> Delete <span class='txt-color-orangeDark'></span> ?",
                                content: $this.data('logout-msg') || "Are you sure you want to delete?",
                                buttons: '[No][Yes]'
                    ...
                    var actionEvents = {
                        ...
                        deleteData: function (e) {
                            smartActions.deleteData(element);
                        },
...
angular.module('app.navigation', [])
        ...
        .controller('NavGroupController', ['$scope', '$rootScope', function ($scope, $rootScope) {
                $scope.active = false;
                ...
                $scope.rl = $rootScope.globals.currentUser.data.user.type;
               // console.log($scope.rl);
                $scope.show = ($scope.role.indexOf($scope.rl) !== -1);
        ...
        .directive('navGroup', function () {
            return {
                ...
                template: '\
				<li data-ng-class="{active: active}" ng-show="{{show}}" role="{{ role }}">\
					<a href="">\
        ...
        .controller('NavItemController', ['$rootScope', '$scope', '$location', function ($rootScope, $scope, $location) {
                ...
                $scope.getItemTarget = function () {
                  ...
                  //console.log($rootScope.globals.currentUser.data.user.type);  
        ...
        .directive('navItem', ['ribbon', '$window', function (ribbon, $window) {
                return {
                    ...
                    link: function (scope, element, attrs, parentCtrls) {
                        ...
                        scope.show = scope.isChild === true ? true : scope.show;
                    ...
                    replace: true,
                    template: '\
				<li data-ng-class="{active: isActive(view)}" ng-show={{show}} role="{{ role }}">\
